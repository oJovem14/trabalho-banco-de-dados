...
--
-- Host: 127.0.0.1
-- Tempo de geração: 01/09/2025 às 15:18
...
--
CREATE DATABASE IF NOT EXISTS `associacao_iubra` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `associacao_iubra`;
...
--
CREATE DATABASE IF NOT EXISTS `associacao_joao` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `associacao_joao`;
...
--
ALTER TABLE `turma`
  ADD CONSTRAINT `turma_ibfk_1` FOREIGN KEY (`id_professor`) REFERENCES `professores` (`id_professor`) ON DELETE CASCADE;
--
-- Banco de dados: `escola_iubra`
--
CREATE DATABASE IF NOT EXISTS `escola_iubra` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `escola_iubra`;
--
-- Banco de dados: `escola_iubraa`
--
CREATE DATABASE IF NOT EXISTS `escola_iubraa` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `escola_iubraa`;
--
-- Banco de dados: `escola_iubraaa`
--
CREATE DATABASE IF NOT EXISTS `escola_iubraaa` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `escola_iubraaa`;
--
-- Banco de dados: `escola_iubraaaa`
--
CREATE DATABASE IF NOT EXISTS `escola_iubraaaa` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `escola_iubraaaa`;
--
-- Banco de dados: `iubra`
--
CREATE DATABASE IF NOT EXISTS `iubra` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `iubra`;
--
...
('root', '[{\"db\":\"\",\"table\":\"associados\"},{\"db\":\"associacao_iubra\",\"table\":\"associados\"},{\"db\":\"associacao_joao\",\"table\":\"associados\"}]');
...
('root', '2025-09-01 13:18:03', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt_BR\",\"NavigationWidth\":0}');
...
ALTER TABLE `matriculas`
  ...
  ADD CONSTRAINT `matriculas_ibfk_2` FOREIGN KEY (`id_turma`) REFERENCES `turma` (`id_turma`) ON DELETE CASCADE;
