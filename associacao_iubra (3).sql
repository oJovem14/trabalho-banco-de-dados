...
--
-- Host: 127.0.0.1
-- Tempo de geração: 05/09/2025 às 14:10
...
--
-- Despejando dados para a tabela `contribuido`
--

INSERT INTO `contribuido` (`id_contribuido`, `data_vencimento`, `valor_pago`, `mes_ano_referencia`, `pendencia`, `data_pagamento`, `status`) VALUES
(1, '2030-08-06', 78, '2025/08', 'Não Pendente', '2025-08-06', 'Pago'),
(2, '2024-02-29', 99, '2024/10', 'Pendente', '2024-09-10', 'Não pago'),
(3, '2028-11-01', 2.899, '2025/01', 'Pendente', '2025-11-01', 'Não pago'),
(4, '2025-09-11', 500, '2014/09', 'Pendente', '2025-09-11', 'Em andamento'),
(5, '2020-05-20', 110, '2020/05', 'Quitado', '2023-05-20', 'Pago');
